...
const getOrdenesConInsta = async(sedeFilter = null) => {
    ...
    try {
        let query = `
            ...
            ic.tipo_equipo, ic.cobro_instalacion, ic.comentario_instalacion, ic.caja_instalacion, ic.user_mk, 
            ...
            ot.clienteinicial_dnicliente, ot.horario_instalacion, ot.indicacion_instalacion, ot.costo_instalacion, 
