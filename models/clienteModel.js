...
const createCliente = async(clientData) => {
    ...
    const { dnicliente, nombrecli, apellidocli, direccioncli, distritocli, provinciacli, fecha_nacimiento, telefonocli } = clientData;

    try {
        const client = await pool.connect();
        const query = 'INSERT INTO cliente(dnicliente, nombrecli, apellidocli, direccioncli, distritocli, provinciacli, fecha_nacimiento, telefonocli) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *';
        const values = [dnicliente, nombrecli, apellidocli, direccioncli, distritocli, provinciacli, fecha_nacimiento, telefonocli];
